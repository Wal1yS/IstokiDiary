...
export const GroupInfoPage1: React.FC<GroupID> = ({ ID }) => {
    ...
    const members = useMemo(() => {
        ...
        const firstNames = ['Иван', 'Пётр', 'Алексей', 'Дмитрий', 'Никита', 'Андрей', 'Сергей', 'Максим', 'Егор'];
        const lastNames = ['Иванов', 'Петров', 'Смирнов', 'Кузнецов', 'Соколов', 'Попов', 'Лебедев', 'Новиков', 'Морозов'];
        const patronymics = ['Иванович', 'Петрович', 'Алексеевич', 'Дмитриевич', 'Андреевич', 'Сергеевич', 'Максимович'];
